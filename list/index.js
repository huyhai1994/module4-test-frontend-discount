...
function displayList() {
    $.ajax({
        method: 'GET', url: 'http://localhost:8080/api/discounts', success: getDiscountList()
    })
}

/*TODO: get discounts list*/
...
/*TODO: tim kiem danh sach giam gia theo so tien*/
